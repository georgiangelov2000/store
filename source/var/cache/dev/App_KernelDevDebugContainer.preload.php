...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\Container8sxentx\App_KernelDevDebugContainer::class, null);
require __DIR__.'/Container8sxentx/UriSignerGhostB68a0a1.php';
require __DIR__.'/Container8sxentx/EntityManagerGhost614a58f.php';
require __DIR__.'/Container8sxentx/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/Container8sxentx/ProfilerProxy8977808.php';
require __DIR__.'/Container8sxentx/getWebpackEncore_TagRendererService.php';
require __DIR__.'/Container8sxentx/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/Container8sxentx/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/Container8sxentx/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/Container8sxentx/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/Container8sxentx/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/Container8sxentx/getValidator_WhenService.php';
require __DIR__.'/Container8sxentx/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container8sxentx/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/Container8sxentx/getValidator_ExpressionLanguageService.php';
require __DIR__.'/Container8sxentx/getValidator_ExpressionService.php';
require __DIR__.'/Container8sxentx/getValidator_EmailService.php';
require __DIR__.'/Container8sxentx/getUriSignerService.php';
require __DIR__.'/Container8sxentx/getTwig_Runtime_SerializerService.php';
require __DIR__.'/Container8sxentx/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container8sxentx/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/Container8sxentx/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container8sxentx/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/Container8sxentx/getTwig_Form_RendererService.php';
require __DIR__.'/Container8sxentx/getTwig_Form_EngineService.php';
require __DIR__.'/Container8sxentx/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_YmlService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_XliffService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_ResService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_QtService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_PoService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_PhpService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_MoService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_JsonService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_IniService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_DatService.php';
require __DIR__.'/Container8sxentx/getTranslation_Loader_CsvService.php';
require __DIR__.'/Container8sxentx/getTexter_TransportsService.php';
require __DIR__.'/Container8sxentx/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/Container8sxentx/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/Container8sxentx/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/Container8sxentx/getSession_Handler_NativeService.php';
require __DIR__.'/Container8sxentx/getSession_FactoryService.php';
require __DIR__.'/Container8sxentx/getServicesResetterService.php';
require __DIR__.'/Container8sxentx/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container8sxentx/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/Container8sxentx/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/Container8sxentx/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/Container8sxentx/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/Container8sxentx/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container8sxentx/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container8sxentx/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container8sxentx/getSecurity_AccessListenerService.php';
require __DIR__.'/Container8sxentx/getSecrets_VaultService.php';
require __DIR__.'/Container8sxentx/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/Container8sxentx/getRouting_LoaderService.php';
require __DIR__.'/Container8sxentx/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container8sxentx/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/Container8sxentx/getMonolog_Logger_MessengerService.php';
require __DIR__.'/Container8sxentx/getMonolog_Logger_MailerService.php';
require __DIR__.'/Container8sxentx/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/Container8sxentx/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/Container8sxentx/getMonolog_LoggerService.php';
require __DIR__.'/Container8sxentx/getMessenger_TransportFactoryService.php';
require __DIR__.'/Container8sxentx/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/Container8sxentx/getMessenger_Transport_InMemory_FactoryService.php';
require __DIR__.'/Container8sxentx/getMessenger_Transport_FailedService.php';
require __DIR__.'/Container8sxentx/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/Container8sxentx/getMessenger_Transport_AsyncService.php';
require __DIR__.'/Container8sxentx/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/Container8sxentx/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/Container8sxentx/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/Container8sxentx/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/Container8sxentx/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/Container8sxentx/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/Container8sxentx/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/Container8sxentx/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/Container8sxentx/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/Container8sxentx/getMailer_TransportsService.php';
require __DIR__.'/Container8sxentx/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/Container8sxentx/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/Container8sxentx/getMailer_TransportFactory_NullService.php';
require __DIR__.'/Container8sxentx/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/Container8sxentx/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container8sxentx/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/Container8sxentx/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Password_PasswordHasherService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Form_PasswordHasherService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/Container8sxentx/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/Container8sxentx/getForm_Type_FormService.php';
require __DIR__.'/Container8sxentx/getForm_Type_FileService.php';
require __DIR__.'/Container8sxentx/getForm_Type_EntityService.php';
require __DIR__.'/Container8sxentx/getForm_Type_ColorService.php';
require __DIR__.'/Container8sxentx/getForm_Type_ChoiceService.php';
require __DIR__.'/Container8sxentx/getForm_ServerParamsService.php';
require __DIR__.'/Container8sxentx/getForm_RegistryService.php';
require __DIR__.'/Container8sxentx/getForm_Listener_PasswordHasherService.php';
require __DIR__.'/Container8sxentx/getForm_FactoryService.php';
require __DIR__.'/Container8sxentx/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/Container8sxentx/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/Container8sxentx/getErrorControllerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/Container8sxentx/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container8sxentx/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container8sxentx/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container8sxentx/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/Container8sxentx/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/Container8sxentx/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/Container8sxentx/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/Container8sxentx/getController_TemplateAttributeListenerService.php';
require __DIR__.'/Container8sxentx/getContainer_GetenvService.php';
require __DIR__.'/Container8sxentx/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/Container8sxentx/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container8sxentx/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container8sxentx/getCache_SystemClearerService.php';
require __DIR__.'/Container8sxentx/getCache_GlobalClearerService.php';
require __DIR__.'/Container8sxentx/getCache_AppClearerService.php';
require __DIR__.'/Container8sxentx/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/Container8sxentx/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/Container8sxentx/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/Container8sxentx/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/Container8sxentx/getTemplateControllerService.php';
require __DIR__.'/Container8sxentx/getRedirectControllerService.php';
require __DIR__.'/Container8sxentx/getProfilerControllerService.php';
require __DIR__.'/Container8sxentx/getProductServiceService.php';
require __DIR__.'/Container8sxentx/getOrderServiceService.php';
require __DIR__.'/Container8sxentx/getProductRepositoryService.php';
require __DIR__.'/Container8sxentx/getOrderRepositoryService.php';
require __DIR__.'/Container8sxentx/getProductController2Service.php';
require __DIR__.'/Container8sxentx/getHomeControllerService.php';
require __DIR__.'/Container8sxentx/getProductControllerService.php';
require __DIR__.'/Container8sxentx/getOrderControllerService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_JsQaLu1Service.php';
require __DIR__.'/Container8sxentx/getOrderControllerupdateOrderStatusService.php';
require __DIR__.'/Container8sxentx/getOrderControllercreateOrderService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_AxWvN5HService.php';
require __DIR__.'/Container8sxentx/getOrderControllergetOrdersService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_ZyP9f7KService.php';
require __DIR__.'/Container8sxentx/get_ServiceLocator_SVfEC_PService.php';
require __DIR__.'/Container8sxentx/getProductControllerlistProductsService.php';
require __DIR__.'/Container8sxentx/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_JyyWvHwService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_GEx8y9aService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_WG_ORBvService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_UKIJHilService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_Qv3faSNService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_NumTeF8Service.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_EXsqOW5Service.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_Dkv9sRYService.php';
require __DIR__.'/Container8sxentx/get_Messenger_HandlerDescriptor_Die6BxeService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/Container8sxentx/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/Container8sxentx/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container8sxentx/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container8sxentx/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\API\OrderController';
$classes[] = 'App\Service\CheckoutService';
